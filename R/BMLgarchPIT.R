#' @title <BMLgarch>
#'
#' @description <Iteratively fitting MSGARCH models relying on their DIC values>
#' @param X A vector containing dependent variable observations.
#' @param k Integer, number of regimes to fit in the MSGARCH model, default is 2.
#' @param show.spec Logical, if true it shows specifications fitted at each iteration.
#' @param burns Integer. MCMC parameter, draws to burn, default is 800.
#' @param mcmc Integer. MCMC parameter, draws to keep, default is 1700.
#' @param Dic Real number, the maximum value of DIC to accept a model, default is -5000.
#' @param maxht Real number, the maximum value of fitted h(t) to keep the model, default value is 2.
#' @param fortime Integer, number of n steps ahead to compute out-of-sample forecasts, default is 7.
#' @param ndraws Integer, number of MCMC draws to compute at each of the n steps ahead to forecast, default is 700.
#' @param sds Real number, upper and lower bounds (in terms of standard deviations) of predicted values,default is 3.
#' @export
